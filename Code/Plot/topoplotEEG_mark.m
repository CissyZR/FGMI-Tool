...
function handle = topoplotEEG_mark(Vl,loc_file,p1,v1,p2,v2,p3,v3,p4,v4,p5,v5,p6,v6,p7,v7,p8,v8,p9,v9,p10,v10)
...
if strcmp(ELECTROD,'on') 
    ...
    %         hp2 = scatter(y(~markedIdx),x(~markedIdx),EMARKERSIZE,[0 0 0],'filled');
            hp2 = scatter(y(markedIdx),x(markedIdx),3*EMARKERSIZE,mVal,'filled');
        end
    end
