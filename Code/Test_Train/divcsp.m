...
% von B眉nau et al., Finding Stationary Subspaces in Multivariate Time Series, Phys Rev Let, 2009.
%
% Author(s): Wojciech Samek
% wojciech.samek@tu-berlin.de
%
% If using our code please cite one of the papers:
% W. Samek, M. Kawanabe, K.-R. M眉ller, Divergence-based Framework for Common Spatial Patterns Algorithms
% IEEE Reviews in Biomedical Engineering, 2014.
%
% W. Samek, D. Blythe, K.-R. M眉ller, M. Kawanabe, Robust Spatial Filtering with Beta Divergence
...
if opts.nreps >= 1
  ...
  opts.nreps = 0;
  for i=1:nreps
	 if(opts.csp_init==true && i==1) %只有第一次初始化时利用csp方法
